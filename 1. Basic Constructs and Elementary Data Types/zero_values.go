...
integer-> value: 0, type: int
float-> value: 0, type: float32
stringv-> value: , type: string
pointer-> value: &{}, type: *struct {}
function-> value: <nil>, type: func()
interfacev-> value: <nil>, type: <nil>
slice-> value: [], type: []int
channel-> value: 0xc00001a120, type: chan int
mapv-> value: map[], type: map[string]string
map[k:v], map[]
*/